...
impl Precise {
    ...
    fn mfcc_spec(raw: &[i16], params: &PreciseParams) -> Array2<f32> {
        ...
        mfcc(x.view(), params.sample_rate, params.window_samples() as f64, params.hop_samples() as f64, params.n_mfcc as usize, params.n_filt as usize, 512, 0 as f64, None, true).mapv(|f|f as f32)
    }
