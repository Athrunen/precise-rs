...
impl Precise {
    ...
    fn mfcc_spec(raw: &[i16], params: &PreciseParams) -> Array2<f32> {
        ...
        mfcc(x.view(), params.sample_rate.into(), params.window_samples().into(), params.hop_samples().into(), params.n_mfcc.into(), params.n_filt.into(), 512, 0.into(), None, true).mapv(|f|f as f32)
    }
